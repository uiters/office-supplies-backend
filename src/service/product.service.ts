...
export default class ProductService {
  ...
  private async _updateRatePoints(productId: string) {
    ...
    foundProduct.ratePoints = await ratingService.calculateRating(
      foundProduct._id
    );
  ...
  public async updateProduct(id: string, data: IBook) {
    ...
    if (data.productName !== undefined)
      foundProduct.productName = data.productName;
    if (data.categoriesId !== undefined)
      foundProduct.categoriesId = data.categoriesId;
    ...
    if (data.productImage !== undefined)
      foundProduct.productImage = data.productImage;
